...
import { deletepengirimanId, generatePengiriman, getAllpengiriman, getAllpengirimanpaginate, getpengirimanById, postpengiriman, putpengiriman } from "../service/pengirimanService";
